...
<main role="main" class="col-md-9 ml-sm-auto col-lg-12 pt-3 px-4">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="edit_job.php">update jobs</a></li>
</ol>
</nav>
...
<div class="wrapper rounded bg-white">
        ...
        <div class="form">
            <div class="row">
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <input type="text" class="form-control" name="job_title"required value="<?php echo $data['job_title'];?>">
      ...
      <textarea id="my-textarea" class="form-control" name="description" rows="10"> <?php echo $data['description'];?></textarea>
          ...
          <button type="submit" class="btn btn-block btn-danger mt-1" name="add">Update Job</button>
